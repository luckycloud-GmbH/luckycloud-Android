...
public class TransferService extends Service {
    ...
    private class mainTask extends TimerTask
    {
        public void run()
        {
            if (!isTransferring() && isStartForeground) {
    ...
    public int addTaskToUploadQueBlock(Account account, String repoID, String repoName, String dir,
        ...
        return addTaskToSourceQueBlock("", account, repoID, repoName, dir, filePath, isUpdate, isCopyToLocal);
    }

    public int addTaskToSourceQueBlock(String source, Account account, String repoID, String repoName, String dir,
                                       String filePath, boolean isUpdate, boolean isCopyToLocal) {
        return uploadTaskManager.addTaskToQue(source, account, repoID, repoName, dir, filePath, isUpdate, isCopyToLocal, true);
    }
    ...
    // -------------------------- download task --------------------//
    public int addDownloadTask(Account account, String repoName, String repoID, String path, boolean offlineAvailable) {
        return addDownloadTask(account, repoName, repoID, path, -1L, offlineAvailable, false);
    }

    public int addDownloadTask(Account account, String repoName, String repoID, String path, boolean offlineAvailable, boolean thumbnail) {
        return addDownloadTask(account, repoName, repoID, path, -1L, offlineAvailable, thumbnail);
    }

    public int addDownloadTask(Account account, String repoName, String repoID, String path, long fileSize, boolean offlineAvailable) {
        return addDownloadTask(account, repoName, repoID, path, fileSize, offlineAvailable, false);
    }

    public int addDownloadTask(Account account, String repoName, String repoID, String path, long fileSize, boolean offlineAvailable, boolean thumbnail) {
        return downloadTaskManager.addTask(account, repoName, repoID, path, fileSize, offlineAvailable, thumbnail);
    }

    public void addTaskToDownloadQue(Account account, String repoName, String repoID, String path, boolean offlineAvailable, boolean thumbnail, long size) {
        downloadTaskManager.addTaskToQue(account, repoName, repoID, path, offlineAvailable, thumbnail, size);
    }
    ...
    public int getDownloadWaitingListSize() {
        return downloadTaskManager.waitingList.size();
    }
}
