...
public class SeafileAuthenticatorActivity extends BaseAuthenticatorActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        intent.putExtras(getIntent());
        if (AccountsActivity.getIsEnterpriseLogin()) {
            intent.putExtra(SeafileAuthenticatorActivity.ARG_SERVER_URI, getString(R.string.enterprise_example_url));
    ...
    private void finishLogin(Intent intent) {
        if (intent == null){
            ...
            Intent newIntent = new Intent(this, BrowserActivity.class);
