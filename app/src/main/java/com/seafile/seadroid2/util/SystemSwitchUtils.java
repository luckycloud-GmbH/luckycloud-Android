...
public class SystemSwitchUtils {
    ...
    public static String timestamp2ISO(long timestamp) {
        try {
            DateFormat sdf = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ssZ");
    ...
    public static int op_type(Context ct, String obj_type, String op_type) {
        int color = R.color.luckycloud_green;
        if (op_type.equals("create")) {
            color = R.color.luckycloud_green;
        } else if (op_type.equals("rename")) {
            color = R.color.lucky_yellow;
        } else if (op_type.equals("delete")) {
            color = R.color.red;
        } else if (op_type.equals("restore")) {
            color = R.color.luckycloud_green;
        ...
        return ct.getResources().getColor(color);
    }
}