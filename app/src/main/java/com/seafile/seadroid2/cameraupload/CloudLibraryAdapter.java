...
public class CloudLibraryAdapter extends ReposAdapter {
    ...
    public CloudLibraryAdapter(boolean onlyShowWritableRepos, String encryptedRepoId, Context context, String currentActivity) {
        super(onlyShowWritableRepos, encryptedRepoId, context, currentActivity);
    }
    ...
    @Override
    protected int getChildCardId() {
        return R.id.cuc_repo_list_item_card;
    }
