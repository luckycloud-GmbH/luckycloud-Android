 ...
 *
#########################################################*/
package com.seafile.seadroid2.document.markor.format.markdown;
...
public class MarkdownActionButtons extends ActionButtonBase {
    ...
    String getFormatActionsKey() {
        return "pref_key__markdown__action_keys";
    }
    ...
    public List<ActionItem> getFormatActionList() {
        return Arrays.asList(
                ...
                new ActionItem(abid_markdown_bold, R.drawable.ic_format_bold, R.string.bold),
                new ActionItem(abid_markdown_italic, R.drawable.ic_format_italic, R.string.italic),
                new ActionItem(abid_markdown_strikeout, R.drawable.ic_format_strikethrough_black_24dp, R.string.strikeout),
                new ActionItem(abid_markdown_code_inline, R.drawable.ic_code_black_24dp, R.string.inline_code),
                new ActionItem(abid_markdown_quote, R.drawable.ic_format_quote, R.string.quote),
                new ActionItem(abid_markdown_h1, R.drawable.format_header_1, R.string.heading_1),
                new ActionItem(abid_markdown_h2, R.drawable.format_header_2, R.string.heading_2),
                new ActionItem(abid_markdown_h3, R.drawable.format_header_3, R.string.heading_3),
                new ActionItem(abid_markdown_horizontal_line, R.drawable.bs_ic_more, R.string.horizontal_line),
    ...
    public boolean onActionClick(final @StringRes int action) {
        switch (action) {
            ...
            case abid_markdown_bold: {
                runSurroundAction("**");
                return true;
            }
            case abid_markdown_italic: {
                runSurroundAction("_");
                return true;
            }
            case abid_markdown_strikeout: {
                runSurroundAction("~~");
                return true;
            }
            case abid_markdown_code_inline: {
                runSurroundAction("`");
                return true;
            }
            case abid_markdown_horizontal_line: {
