...
public class FileMonitorService extends Service {
    ...
    private static void sendDownloadSuccessMessage() {
        Context context = SeadroidApplication.getAppContext();
//        if ( SeadroidApplication.getInstance().isActivityVisible().equals("RESUMED")) {
//            Intent intent = new Intent(BaseActivity.DOWNLOAD_FINISHED_FILTER);
//            // You can also include some extra data.
//            intent.putExtra("Status", context.getString(R.string.download_finished));
