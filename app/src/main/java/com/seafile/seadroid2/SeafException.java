...
public class SeafException extends Exception {
    ...
    public static final int UPLOAD_EXCEPTION = 544;
    ...
    public static SeafException fromJsonString(String jsonString) {
        JSONObject object = Utils.parseJsonObject(jsonString);
        if (object == null) {
            return null;
        }
        return new SeafException(object.optInt("code"), object.optString("msg"));
    }
}
