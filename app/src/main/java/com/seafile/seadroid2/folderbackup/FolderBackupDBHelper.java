...
public class FolderBackupDBHelper extends SQLiteOpenHelper {
    ...
    public void clearBackupFileInfo() {
//        database.execSQL("delete from "+ SAVE_FOLDER_BACKUP_FILE_TABLE_NAME);
        database.delete(SAVE_FOLDER_BACKUP_FILE_TABLE_NAME, null, null);
    }
