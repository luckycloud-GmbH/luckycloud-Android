...
public class AvatarDBHelper extends SQLiteOpenHelper {
    ...
    public boolean hasAvatar(Account account) {
        ...
        do {
            ...
            if (System.currentTimeMillis() - avatar.getMtime() * 1000 > (5 * 60 * 1000) && Utils.isNetworkOn()) {
                database.delete(AVATAR_TABLE_NAME, selection, new String[] { String.valueOf(avatar.getSignature()) });
                hasAvatar = false;
            }
