...
public class FetchFileDialog extends DialogFragment {
    ...
    private void startDownloadFile() {
        ...
        taskID = mActivity.getTransferService().addDownloadTask(mActivity.getAccount(),
                                                                repoName, repoID, path, fileSize, true);
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        okCard = (CardView)view.findViewById(R.id.single_ok_card);
        okText = (TextView)view.findViewById(R.id.single_ok_text);
        ...
        okText.setText(R.string.cancel);
