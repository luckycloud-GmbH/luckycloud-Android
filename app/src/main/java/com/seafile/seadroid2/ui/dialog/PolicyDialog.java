...
public class PolicyDialog extends Dialog {
    ...
    private CardView mConfirmCard, mCancelCard;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCancelCard = findViewById(R.id.cancel_card);
        mCancelText = findViewById(R.id.cancel_text);
        mConfirmCard = findViewById(R.id.ok_card);
        mConfirmText = findViewById(R.id.ok_text);
        ...
        mConfirmText.setText("同意");
        mCancelText.setText("暂不使用");
