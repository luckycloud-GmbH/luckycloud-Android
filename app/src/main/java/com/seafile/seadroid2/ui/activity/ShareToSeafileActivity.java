...
public class ShareToSeafileActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            ...
            if(localPathList == null) localPathList = new ArrayList<String>();
    ...
    private void notifyFileOverwriting(final Account account,
        ...
        if (dirents != null) {
            ...
            if (fileExistent) {
                ...
                dialog.setContentView(R.layout.dialog_share_overwrite);

                TextView titleText = dialog.findViewById(R.id.title_text);
                TextView subtitleText = dialog.findViewById(R.id.subtitle_text);
                CardView noCard = dialog.findViewById(R.id.no_card);
                CardView cancelCard = dialog.findViewById(R.id.cancel_card);
                CardView yesCard = dialog.findViewById(R.id.yes_card);

                titleText.setText(getString(R.string.overwrite_existing_file_title));
                subtitleText.setText(getString(R.string.overwrite_existing_file_msg));
                noCard.setOnClickListener(v -> {
