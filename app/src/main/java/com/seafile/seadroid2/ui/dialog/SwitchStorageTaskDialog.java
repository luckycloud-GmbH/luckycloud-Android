...
public class SwitchStorageTaskDialog extends TaskDialog {
    ...
    protected View createDialogContentView(LayoutInflater inflater, Bundle savedInstanceState) {
        ...
        for (StorageManager.Location location: options) {
            ...
            b.setButtonDrawable(R.drawable.rounded_checkbox2);
            b.setText(location.description);
            b.setTextColor(getResources().getColor(R.color.text_view_color));
            b.setTextSize(TypedValue.COMPLEX_UNIT_PX, getResources().getDimension(R.dimen.title_txt_size));
            b.setLineSpacing(TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 10.0f,  getResources().getDisplayMetrics()), 1.0f);
            RadioGroup.LayoutParams params = new RadioGroup.LayoutParams(
                    ViewGroup.LayoutParams.WRAP_CONTENT,
                    ViewGroup.LayoutParams.WRAP_CONTENT
            );
            params.setMargins(0, (int)(getResources().getDimension(R.dimen.margin_big)), 0, 0);
            b.setLayoutParams(params);
            b.setPadding((int)(getResources().getDimension(R.dimen.radio_text_padding)), 0, 0, 0);
...
//        dialog.setTitle(getResources().getString(R.string.settings_cache_location_title));
        updateTitleText(getResources().getString(R.string.settings_cache_location_title));
    }
