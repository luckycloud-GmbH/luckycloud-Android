...
public class CreateGesturePasswordActivity extends BaseActivity implements Toolbar.OnMenuItemClickListener {
    private static final int ID_EMPTY_MESSAGE = -1;
    private static final String KEY_UI_STAGE = "uiStage";
    private static final String KEY_PATTERN_CHOICE = "chosenPattern";
    private LockPatternView mLockPatternView;
    private CardView mFooterRightCard;
    private CardView mFooterLeftCard;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mFooterRightCard = (CardView) this.findViewById(R.id.right_card);
        mFooterLeftCard = (CardView) this.findViewById(R.id.reset_card);

        mFooterRightCard.setOnClickListener(v -> {
        ...
        mFooterLeftCard.setOnClickListener(v -> {
        ...
        mFooterRightText = (TextView) this.findViewById(R.id.right_text);
        mFooterLeftText = (TextView) this.findViewById(R.id.reset_text);
    ...
    protected LockPatternView.OnPatternListener mChooseNewLockPatternListener = new LockPatternView.OnPatternListener() {
        ...
        private void patternInProgress() {
            ...
            mFooterLeftCard.setEnabled(false);
            mFooterRightCard.setEnabled(false);
        }
    };
    ...
    private void updateStage(Stage stage) {
        ...
        if (stage.leftMode == LeftButtonMode.Gone) {
            mFooterLeftCard.setVisibility(View.GONE);
        } else {
            mFooterLeftCard.setVisibility(View.VISIBLE);
            mFooterLeftText.setText(stage.leftMode.text);
            mFooterLeftCard.setEnabled(stage.leftMode.enabled);
        }

        mFooterRightText.setText(stage.rightMode.text);
        mFooterRightCard.setEnabled(stage.rightMode.enabled);
